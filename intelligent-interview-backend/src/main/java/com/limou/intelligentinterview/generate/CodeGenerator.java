package com.limou.intelligentinterview.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.limou.intelligentinterview"; // NOTE: 只需要修改这四个值直接运行就可以生成 CRUD 代码
        String dataName = "题库题目关联表";
        String dataKey = "questionBankQuestion"; // 小驼峰
        String upperDataKey = "QuestionBankQuestion"; // 大驼峰
