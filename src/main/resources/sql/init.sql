-- 项目数库
DROP DATABASE IF EXISTS work_question_bank;
CREATE DATABASE work_question_bank CHARACTER SET utf8mb4 COLLATE = utf8mb4_unicode_ci;
USE work_question_bank;

-- 项目用户
DROP USER IF EXISTS 'wqb'@'%';
CREATE USER 'wqb'@'%' IDENTIFIED BY 'Qwe54188_';
