...
import cn.com.edtechhub.workquestionbank.request.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        String encryptPassword = DigestUtils.md5DigestAsHex((mybatisPlusConfig.getSalt() + defaultPassword).getBytes());
