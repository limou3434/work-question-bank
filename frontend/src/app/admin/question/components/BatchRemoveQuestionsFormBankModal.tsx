/**
 * src/app/admin/question/components/BatchRemoveQuestionToBankModal.tsx
 * 批量解绑题目弹窗组件
 */
...
/* 定义 */
// 更新弹窗
const BatchRemoveQuestionsFormBankModal: React.FC<Props> = (props) => {
...
/* 导出 */
export default BatchRemoveQuestionsFormBankModal;
